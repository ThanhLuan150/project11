    ...
    return(
        ...
        <div className="lg:flex lg:flex-row gap-5 flex flex-col">
            <div className="basis-4/6">
                ...
                <div className=" md:grid md:grid-cols-3  grid grid-cols-2 border border-[#cd9a2b] rounded-lg  md:gap-3 gap-0 md:px-3 px-1 py-4">
            ...
            <div className="basis-2/6 bg-[#F2F2F2] rounded-lg px-4 py-2 w-full">
                ...
                <div className="grid grid-cols-2 gap-3">
                    <div className="w-full">
                        ...
                        <input className="border rounded-lg py-2 px-2 placeholder:text-[#6c707e] placeholder:font-mono text-[#6c707e] outline-none w-full" type="text"name="" placeholder="Họ và tên"></input>
                    </div>
                    <div className="w-full">
                        <div className="text-[#333] text-[14px] font-mono my-2">Số điện thoại*</div>
                        <input className="border rounded-lg py-2 px-2 placeholder:text-[#6c707e] placeholder:font-mono text-[#6c707e] outline-none w-full" type="phone"name="" placeholder="Số điện thoại"></input>
                    </div>
                    <div className="w-full">
                        <div className="text-[#333] text-[14px] font-mono my-2">Ngày nhận</div>
                        <input className="border rounded-lg py-2 px-2 placeholder:text-[#6c707e] placeholder:font-mono text-[#6c707e] outline-none w-full" type="date" name="" placeholder="Họ và tên"></input>
                    </div>
                    <div className="w-full">
                        <div className="text-[#333] text-[14px] font-mono my-2">Ngày nhận</div>
                        <input className="border rounded-lg py-2 px-2 placeholder:text-[#6c707e] placeholder:font-mono text-[#6c707e] outline-none w-full" type="date"name=""></input>
                    </div>
                    <div className="w-full">
                        <div className="text-[#333] text-[14px] font-mono my-2">Người lớn</div>
                        <input className="border rounded-lg py-2 px-2 placeholder:text-[#6c707e] placeholder:font-mono text-[#6c707e] outline-none w-full" type="text"name="" placeholder="Người lớn"></input>
                    </div>
                    <div className="w-full">
                        <div className="text-[#333] text-[14px] font-mono my-2">Trẻ em</div>
                        <input className="border rounded-lg py-2 px-2 placeholder:text-[#6c707e] placeholder:font-mono text-[#6c707e] outline-none w-full" type="text"name="" placeholder="Trẻ em"></input>
                    </div>
                    <div className="py-3 ">
