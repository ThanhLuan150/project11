    ...
    return (
        ...
        <div className="my-5">
            <div className="flex gap-2">
                <div
                    className={`${showContent1? "bg-[#cd9a2b] text-white": "bg-white text-black"} flex justify-center py-2 px-3  items-end w-max text-[18px] font-medium rounded-t-lg cursor-pointer`}onClick={handleClick1}> Mô tả sản phẩm </div><div
                    className={`${showContent2? "bg-[#cd9a2b] text-white": "bg-white text-black"} flex justify-center py-2 px-3  items-end w-max text-[18px] font-medium rounded-t-lg cursor-pointer`}onClick={handleClick2}> Chính sách đổi trả</div>
                </div>
            <div>
            {showContent1 && <div> 
