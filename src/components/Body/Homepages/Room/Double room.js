    ...
    return(
        <div className=" xl:mx-[100px] lg:mx-[30px] md:mx-[20px] mx-[10px]">
            <div className="flex flex-col test-center items-center">
                <a href="/Double" className="text-[30px] uppercase  text-center hover:text-[#ffc107] transition-all duration-500 font-medium">Phòng đôi</a>
            ...
            <div className="xl:grid xl:grid-cols-4 lg:grid lg:grid-cols-3 md:grid md:grid-cols-2 grid grid-cols-1  my-7 gap-5">
               <div className="bg-white drop-shadow-md">
                    <div className="">
                        <a href="/DetailRoom"><img className="w-full h-full " src="https://bizweb.dktcdn.net/thumb/large/100/472/947/products/anh12082233010354fb2894f5b1193.jpg?v=1670338573270"></img></a>
                    </div>
