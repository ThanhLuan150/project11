    ...
    return (
        ...
        <div className="pt-[100px]">
            <div className="bg-[#f5f5f5] py-3 ">
                ...
                <span className="mx-2 text-[#915b10] text-[14px] font-mono"><a href="/Double" >Ẩm thực</a></span>
            </div>
        </div>
        <div className="md:mx-[100px] mx-[30px] my-8">
            <div className="flex flex-row justify-between bg-[#f5f5f5] w-full py-3 px-3 rounded-lg">
                <div className="text-[16px] font-bold uppercase">Ẩm thực</div>
            ...
            <div className="xl:grid xl:grid-cols-4 lg:grid lg:grid-cols-3 md:grid md:grid-cols-2 grid grid-cols-1  my-7 gap-5">
               <div className="bg-white drop-shadow-md relative group">
                    <div className="">
                        <img className="w-full h-full " src="https://bizweb.dktcdn.net/thumb/large/100/472/947/products/sp3c.jpg?v=1670338561717"></img>
                    </div>
