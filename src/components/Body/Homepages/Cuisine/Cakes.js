...
const Cakes =() =>{
    ...
    const id_categori_foods = 3; // Thay thế bằng ID thực mà bạn muốn tìm nạp
    ...
    return(
        <>
            ...
            <div class="flex flex-row justify-center items-center"> 
                <a href='/Cake' className="bg-[#cd9a2b]  items-center text-[14px]  justify-center uppercase  text-white w-max py-2 px-5 font-mono cursor-pointer hover:bg-white border hover:border-[#cd9a2b] hover:text-[#cd9a2b] transition-all duration-500 my-3">Xem thêm</a>
            </div>
        </>
    )
}
